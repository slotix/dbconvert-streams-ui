    ...
    <FilterBuilderShell class="mt-3 border-0">
      ...
      <div v-if="showPreview" class="mt-4 pt-3 border-t border-gray-200/80 dark:border-gray-700/80">
        ...
        >
          ...
          <div
            v-if="previewError"
            class="p-3 text-xs text-red-600 dark:text-red-300 bg-red-50 dark:bg-red-950/35 border border-red-200 dark:border-red-700/70"
          >
            <div class="flex items-start gap-2">
              <AlertTriangle class="w-4 h-4 shrink-0 mt-0.5" />
              <div>
                <p class="font-medium">Query error</p>
                <p class="mt-1 text-red-500 dark:text-red-200/90">{{ previewError }}</p>
              </div>
            </div>
          </div>
