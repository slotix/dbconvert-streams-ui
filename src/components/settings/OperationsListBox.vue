    ...
    <div class="relative mt-2">
      ...
      <transition leave-active-class="transition ease-in duration-100" leave-from-class="opacity-100"
        ...
        <ListboxOptions
          ...
          <ListboxOption as="template" v-for="operation in operations" :key="operation" :value="operation"
            ...
            <li :class="[
              ...
              <span class="pl-8" :class="[selected ? 'font-semibold' : 'font-normal', 'block truncate']">{{ operation
                }}</span>
            </li>
          </ListboxOption>
        </ListboxOptions>
