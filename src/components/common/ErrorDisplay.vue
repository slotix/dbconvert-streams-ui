...
<template>
  ...
  >
    <slot v-if="error" :error="error">
      <div
        class="rounded-md bg-red-50 dark:bg-red-900/30 border border-red-200 dark:border-red-700/70 p-4"
      >
        <div class="flex">
          <div class="shrink-0">
            <XCircle v-if="!error.isRetrying" class="h-5 w-5 text-red-500 dark:text-red-200" />
