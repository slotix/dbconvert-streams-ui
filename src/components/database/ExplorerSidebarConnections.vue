...
<template>
  <div ref="sidebarCardRef" class="overflow-hidden h-full flex flex-col">
    ...
    <div class="px-3 pt-2.5 pb-1 flex flex-wrap items-center gap-2">
      <button
        type="button"
        class="lg:hidden shrink-0 flex items-center justify-center p-1.5 rounded-md text-gray-600 hover:text-gray-900 hover:bg-(--ui-surface-muted) dark:text-gray-400 dark:hover:text-white"
