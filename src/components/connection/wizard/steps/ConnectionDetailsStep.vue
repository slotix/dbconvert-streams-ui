...
import { updateAutoGeneratedName } from '@/utils/connectionNameGenerator'
...
// Watch for changes in connection parameters and auto-update name
watch(
  () => connectionsStore.currentConnection,
  (connection) => {
    if (connection) {
      updateAutoGeneratedName(connection)
    }
  },
