...
import { InformationCircleIcon, XMarkIcon, ChevronUpIcon, ChevronDownIcon } from '@heroicons/vue/24/outline'
        ...
        <div class="rounded-lg bg-blue-50 border border-blue-100 shadow-sm">
            ...
            <div v-if="!isExpanded"
                ...
                <div class="ml-auto flex items-center space-x-2">
                    ...
                    <button @click.stop="handleClose" class="text-blue-400 hover:text-blue-600 transition-colors"
                        title="Dismiss">
            ...
            <div v-else class="p-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center">
                        <InformationCircleIcon class="h-5 w-5 text-blue-600 flex-shrink-0" />
                        <h3 class="ml-2 text-base font-medium text-blue-700">
                            Database Access Configuration
                        </h3>
                    </div>
                ...
                <div class="mt-3 text-blue-700">
                    <div class="flex items-baseline">
                        ...
                        <code class="ml-2 px-2 py-0.5 bg-white rounded border border-blue-200 text-blue-700 font-mono">
                            {{ publicIp }}
                        </code>
                    </div>

                    <a href="https://docs.dbconvert.com/network-security/database-access-configuration.html"
