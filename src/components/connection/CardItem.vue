  ...
  <div class="w-full py-2">
    ...
    >
      ...
      >
        <div class="flex items-center gap-4 min-w-0">
          ...
          <div class="flex flex-col min-w-0">
            <span
              class="uppercase tracking-wide text-sm font-bold truncate"
              :class="{
      ...
      <div class="bg-white p-4 space-y-3">
        <div
          class="rounded-lg p-3 bg-opacity-50"
          :class="{
            'bg-yellow-50': selected && currentStep?.name === 'source',
            'bg-green-50': selected && currentStep?.name === 'target',
            'bg-gray-50': !selected
      ...
      <div
        v-show="!isStreamsPage"
        class="mt-auto flex divide-x divide-gray-200"
        :class="{
          'bg-yellow-50': selected && currentStep?.name === 'source',
          'bg-green-50': selected && currentStep?.name === 'target',
          'bg-gray-50': !selected
