    ...
    <div
      ...
      <div class="flex flex-wrap items-center bg-gray-100 p-4">
        <div class="item w-2/5 flex">
          <img v-if="source && source.type" class="h-8 w-8 rounded-full" :src="logoSrc(this.source.type)"
          ...
          <img v-if="target && target.type" class="h-8 w-8 rounded-full" :src="logoSrc(this.target.type)"
      ...
      <div class="-mt-px flex">
        <div class="-ml-px flex w-0 flex-1">
          <ActionsMenu
            class="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-bl-lg  py-4 text-sm font-semibold  bg-gray-200"
             :position="actionsMenuPosition" @selectRow="selectStream" @cloneRow="cloneStream"
        ...
        <div class="-ml-px flex w-0 flex-1">
          <button type="button"
            class="relative inline-flex w-0 flex-1 items-center justify-center gap-x-3 rounded-br-lg border-l border-gray-400 py-4 text-sm font-semibold text-red-600 bg-gray-200">
