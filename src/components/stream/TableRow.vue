<template>
    ...
    <div class="flex items-center">
      <div class="flex-auto">
        ...
        <div class="mt-1 text-xs leading-5 text-gray-500 flex items-center">
          <span v-tooltip="isIdExpanded ? 'Collapse ID' : 'Expand ID'" class="cursor-pointer"
            @click.stop="toggleIdExpansion">
            ID: {{ displayedId }}
          </span>
          <button v-tooltip="'Copy full ID'" class="ml-2 text-gray-500 hover:text-gray-700" @click.stop="copyId">
  ...
  <td class="px-5 py-5">
    <ActionsMenu :position="actionsMenuPosition" @selectRow="selectStream" @editRow="editStream" @cloneRow="cloneStream"
