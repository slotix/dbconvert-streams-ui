      ...
      <div class="flex items-start group hover:bg-gray-50 p-3 rounded-lg transition-colors">
        ...
        <div class="ml-4 flex-1">
          <div class="flex items-center justify-between">
            ...
            <span v-if="subscriptionStatus === 'paused'"
          ...
          <div v-if="subscriptionStatus === 'paused'" class="mt-2 flex items-start space-x-2">
            <div class="flex-shrink-0 mt-0.5">
              <svg class="h-4 w-4 text-orange-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                fill="currentColor">
        ...
        <div class="ml-4 flex-1">
          <div class="flex items-center justify-between">
            ...
            <span class="text-sm text-gray-500">
              {{ currentPeriodStart ? currentPeriodStart : 'N/A' }} - {{ currentPeriodEnd ? currentPeriodEnd : 'N/A' }}
            </span>
          </div>
          <div class="mt-3">
            <div class="flex items-baseline">
              <span class="text-xl font-semibold text-gray-900">{{ formatDataSize(usedData) }}</span>
            ...
            <div class="w-full bg-gray-100 rounded-full h-2.5 mt-2">
              <div class="h-2.5 rounded-full transition-all duration-300" :style="{ width: `${usagePercentage}%` }"
                :class="{
            ...
            <div class="flex items-center justify-between mt-1">
              ...
              <p v-if="usagePercentage > 90" class="text-sm text-red-600 font-medium">Critical usage</p>
              <p v-else-if="usagePercentage > 75" class="text-sm text-yellow-600 font-medium">High usage</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="ml-4 flex-1">
          <div class="flex items-center justify-between">
            <div>
              ...
              <p class="text-xs text-gray-500 mt-0.5">Use this key to authenticate your API requests</p>
            </div>
          </div>
