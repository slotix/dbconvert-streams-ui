  ...
  <div class="space-y-6">
        ...
        >
          <div class="flex items-center">
            <div class="flex-shrink-0">
              ...
              <svg v-if="error.isRetrying" class="animate-spin h-5 w-5 text-yellow-600" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
    ...
    <div v-else class="grid gap-4">
      <div v-for="service in services" :key="service.id"
        class="flex items-center justify-between p-4 rounded-lg border border-gray-200 bg-white hover:bg-gray-50 transition-colors"
      >
