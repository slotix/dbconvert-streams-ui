...
const cloneStreamConfig = async (id: string): Promise<StreamConfig> => {
  return executeWithRetry(async () => {
    const commonStore = useCommonStore();
    const response: AxiosResponse<StreamConfig> = await apiClient.put(`/stream-configs/${id}/clone`, null, {
      headers: { 'X-API-Key': commonStore.apiKey }
    });
    return response.data;
  });
...
const startStream = async (id: string): Promise<StreamConfig> => {
  return executeWithRetry(async () => {
    const commonStore = useCommonStore();
    const response: AxiosResponse<StreamConfig> = await apiClient.post(`/streams/${id}/action`, { action: 'start' }, {
      headers: { 'X-API-Key': commonStore.apiKey }
    });
    return response.data;
  });
...
const pauseStream = async (id: string): Promise<StreamConfig> => {
  return executeWithRetry(async () => {
    const commonStore = useCommonStore();
    const response: AxiosResponse<StreamConfig> = await apiClient.post(`/streams/${id}/action`, { action: 'pause' }, {
      headers: { 'X-API-Key': commonStore.apiKey }
    });
    return response.data;
  });
...
const resumeStream = async (id: string): Promise<StreamConfig> => {
  return executeWithRetry(async () => {
    const commonStore = useCommonStore();
    const response: AxiosResponse<StreamConfig> = await apiClient.post(`/streams/${id}/action`, { action: 'resume' }, {
      headers: { 'X-API-Key': commonStore.apiKey }
    });
    return response.data;
  });
...
const stopStream = async (id: string): Promise<StreamConfig> => {
  return executeWithRetry(async () => {
    const commonStore = useCommonStore();
    const response: AxiosResponse<StreamConfig> = await apiClient.post(`/streams/${id}/action`, { action: 'stop' }, {
      headers: { 'X-API-Key': commonStore.apiKey }
    });
    return response.data;
  });
