        ...
        <TabList class="flex space-x-2 mb-8 border-b border-gray-200">
          <Tab v-slot="{ selected }" as="template">
            ...
            >
              ...
              <span
                v-if="selected"
                class="absolute bottom-0 left-0 w-full h-0.5 bg-slate-600"
              ></span>
            </button>
          </Tab>
          <Tab v-slot="{ selected }" as="template">
        ...
        <TabPanels>
          ...
          <TabPanel>
            <div class="flex gap-8 relative">
              ...
              >
                <div v-if="metadata" class="sticky top-8">
                  <DatabaseStructureTree
                    :metadata="metadata"
                    :selected-name="selectedObjectName"
                    :selected-type="selectedObjectType"
              ...
              >
                <component
                  :is="isSidebarCollapsed ? ChevronRightIcon : ChevronLeftIcon"
